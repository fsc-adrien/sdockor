var zify_products_slider= "";
...
(function() {
    ...
    var zifyJavaScript = function(jQuery) {
        ! function(a, b, c, d) {
            function e(b, c) {
        ...
        //Add_zify_data
        var config_reponse = JSON.parse(B64.decode(zify_products_slider));
        var array_nav = [{
        ...
        idslider.forEach(function(id) {
            //current_url = "/apps/products-slider/ajax?id="+id;
            if (config_reponse.status == 1) {
                var slider_json = window.zify_product_json;
                jQuery.getJSON(slider_json, function(data) {
            ...
            jQuery.ajax({
                ...
                success: function(product) {
                    ...
                    if (product.status != undefined) {
                        ...
                        html_popup = '<span class="zify-success">' + product.title + ' ' + add_success + ' </span>';
                        jQuery.ajax({
                            type: 'GET',
                            url: '/cart.js',
                            dataType: 'json',
                ...
                error: function(obj, status) {
                    ...
                    // openModal();
                    jQuery('body').append(
                        '<div class="zify-popup-products"><div class="zify-notifications-alert"><span class="zify-error" style="color:#FFF">The product you are trying to add is out of stock. </span></div></div>'
                    );
        ...
        jQuery("body").on("change", ".zify-product-select select.product-select", function(event) {
            ...
            if (price != '') {
                if (jQuery('#zify-price-' + id_ele + ' dl.price').hasClass('price--on-sale')) {
                    jQuery('#zify-price-' + id_ele + ' dl.price').find('.price-item--sale').text(price);
                    jQuery('#zify-price-' + id_ele + ' dl.price').find('.price-item--regular').text(compare_at_price);
                } else {
                    jQuery('#zify-price-' + id_ele + ' dl.price').find('.price-item--regular').text(price);
                }
    ...
    function checkScripttag() {
        ...
        for (var i = scripts.length; i--;) {
            ...
            if (scripts[i].innerText.indexOf('asyncLoad') >= 0 && scripts[i].innerText.indexOf("fp.zifyapp.com") >= 0) {
                console.log('Zifyapp product slider app is working.');
                return true
            }
        }
        return false;
